...
% The gradient_descent_visualizer script has been implemented to show the
% convergence path for a test case and J − Jmin as a function of the 
...
disp(['Jmin = ' num2str(J_min_normalized, '%.12f') ...
    ', last J = ' num2str(J_partial_normalized(max_num_iter), '%.12f') ...
