...
frame_size_speech = 1024;% 0.03 * Fs; % 30 ms
frame_size_piano = 2048;%0.03 * Fs; % 30 ms
overlap = 0; % 50%
...
y_lpc(1:frame_size_piano) = filter(1, lpc_coeffs_speech(1, :), residuals_piano(1, :));

for i = 2:num_frames_piano
    y_lpc((i-1)*frame_size_piano+1:i*frame_size_piano) = filter(1, lpc_coeffs_speech(i, :), residuals_piano(i, :));
