...
[signal_shaping_filters, count] = get_shaping_filters(windowed_signal, M, NFFT, true);
plot(freq_spec, -30+db(abs(signal_shaping_filters(1:NFFT/2))), 'DisplayName', 'LPC');
